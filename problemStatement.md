...
**Supported products (initial):** Groww (currently Google Play Store reviews only).
...
Note: A custom MCP server for handling these Play Store reviews and workspace interactions will be created and provided in this project so that it can use it.
